        ...
        <div className={fusion.content} style={{ display: 'grid', gap: 10, alignContent: 'start', paddingBottom: 20 }}>
          ...
          >
            <div style={{ minWidth: 0 }}>
              ...
              <h2 style={{ marginTop: 10, fontSize: 40, lineHeight: 0.96 }}>来局五子棋</h2>
              <p style={{ marginTop: 8, maxWidth: 220 }}>
                先手争势，连五即胜。可在这里直接切换人机、好友房或本地对弈。
              </p>
            </div>
            <div className={fusion.miniBoard} aria-hidden="true" style={{ justifySelf: 'end' }} />
          </section>
